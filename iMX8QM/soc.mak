...
flash_ecockpit_b0: $(MKIMG) $(AHAB_IMG) scfw_tcm.bin ecockpit-ap.bin
...
flash_ecockpit_b0_m4: $(MKIMG) $(AHAB_IMG) scfw_tcm.bin ecockpit-ap.bin m4_image.bin m4_1_image.bin
...
flash_ecockpit_b0_evs: $(MKIMG) $(AHAB_IMG) scfw_tcm.bin ecockpit-ap.bin m4_1_image.bin
	./$(MKIMG) -soc QM -rev B0 -append $(AHAB_IMG) -c -flags 0x00200000 -scfw scfw_tcm.bin -ap u-boot-atf.bin a53 0x80000000 mu0 pt1 -ap u-boot-atf-a72.bin a72 0xC0000000 mu3 pt3 -p5 -m4 m4_1_image.bin 1 0x88800000 -out flash.bin
